CLASS zcl_rap_extensions_gen_c326 DEFINITION
INHERITING FROM zcl_rap_extensions_base_C326
  PUBLIC
   CREATE PUBLIC .
   ...
   PROTECTED SECTION.
     ...
     CONSTANTS:
       co_prefix                     TYPE string           VALUE 'ZAGORA_EXT',
       co_suffix                     TYPE string           VALUE 'AGORA',
       co_entity_name                TYPE string           VALUE 'Shop',
       co_session_name               TYPE string           VALUE 'AGORA_EXT',
...
CLASS ZCL_RAP_EXTENSIONS_GEN_C326 IMPLEMENTATION.
